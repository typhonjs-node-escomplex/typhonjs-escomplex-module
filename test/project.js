...
if (testconfig.modules['project']) {
    parsers.forEach(function (parser) {
        suite('(' + parser.name + '): project:', function () {
            ...
            suite('require:', function () {
                ...
                suite('two modules:', function () {
                    ...
                    setup(function () {
                        result = cr.analyse([
                            {
                                ast: parser.parse('function foo (a, b) { if (a) { b(a); } else { a(b); } } function bar (c, d) { var i; for (i = 0; i < c.length; i += 1) { d += 1; } console.log(d); }', {loc: true}),
                                path: 'b'
                            },
                            {ast: parser.parse('if (true) { "foo"; } else { "bar"; }', {loc: true}), path: 'a'}
                        ], mozWalker);
                    });
                ...
                suite('two modules with different options:', function () {
                    ...
                    setup(function () {
                        ...
                        modules.push({
                            ast: parser.parse('if (true) { "foo"; } else { "bar"; }', {loc: true}),
                            path: 'a'
                        });
                ...
                suite('modules with dependencies:', function () {
                    ...
                    setup(function () {
                        result = cr.analyse([
                            {ast: parser.parse('require("./a");"d";', {loc: true}), path: '/d.js'},
                            {ast: parser.parse('require("./b");"c";', {loc: true}), path: '/a/c.js'},
                            {ast: parser.parse('require("./c");"b";', {loc: true}), path: '/a/b.js'},
                            {ast: parser.parse('require("./a/b");require("./a/c");"a";', {loc: true}), path: '/a.js'}
                        ], mozWalker);
                    });
                ...
                suite('MacCormack, Rusnak & Baldwin example:', function () {
                    ...
                    setup(function () {
                        result = cr.analyse([
                            {ast: parser.parse('"f";', {loc: true}), path: '/a/c/f.js'},
                            {ast: parser.parse('require("./f");"e";', {loc: true}), path: '/a/c/e.js'},
                            {ast: parser.parse('"d";', {loc: true}), path: '/a/b/d.js'},
                            {ast: parser.parse('require("./c/e");"c";', {loc: true}), path: '/a/c.js'},
                            {ast: parser.parse('require("./b/d");"b";', {loc: true}), path: '/a/b.js'},
                            {ast: parser.parse('require("./a/b");require("./a/c");"a";', {loc: true}), path: '/a.js'}
                        ], mozWalker);
                    });
